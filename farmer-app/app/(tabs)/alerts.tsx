...
const SEV: Record<Severity, { color: string; bg: string; border: string }> = {
  CRITICAL: { color: "#f25c5c", bg: "#2a0a0a", border: "#5a1010" },
  HIGH:     { color: "#f5a623", bg: "#271600", border: "#4a2800" },
  MEDIUM:   { color: "#f5d823", bg: "#231a00", border: "#3d2e00" },
  LOW:      { color: "#4dd97a", bg: "#0a2215", border: "#1a4030" },
};
          ...
          <ScrollView style={styles.list} showsVerticalScrollIndicator={false}>
            ...
            {!loading && filtered.length === 0 && (
              <View style={styles.empty}>
                <Ionicons name="shield-checkmark-outline" size={52} color={theme.colors.accent} style={{ opacity: 0.35 }} />
      ...
      {activeTab === "reminders" && (
        <>
          ...
          <ScrollView style={styles.list} showsVerticalScrollIndicator={false}>
            {reminders.length === 0 && (
              <View style={styles.empty}>
                <Ionicons name="alarm-outline" size={52} color={theme.colors.accent} style={{ opacity: 0.35 }} />
...
function AlertCard({ alert, onAcknowledge }: { alert: FarmAlert; onAcknowledge: () => void }) {
  ...
  return (
    <Animated.View style={[
      ...
      {/* CRITICAL pulse glow border */}
      {alert.severity === "CRITICAL" && !alert.acknowledged && (
        <Animated.View style={[styles.criticalGlow, { opacity: pulse }]} />
      )}
      ...
      <View style={{ flex: 1, padding: 13 }}>
        <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 7 }}>
          ...
          {alert.acknowledged && <Text style={{ color: theme.colors.accent, fontSize: 11 }}>✓ Reviewed</Text>}
        ...
        {expanded && alert.recommendation ? (
          <View style={styles.prevention}>
            ...
            {alert.timeline ? <Text style={{ color: theme.colors.warning, fontSize: 11, marginTop: 4 }}>⏱ {alert.timeline}</Text> : null}
            {alert.activity ? <Text style={{ color: theme.colors.safe, fontSize: 11, marginTop: 2 }}>🌿 {alert.activity}</Text> : null}
          </View>
        ) : null}
...
const styles = StyleSheet.create({
  ...
  primaryBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: "#0f3a28", paddingVertical: 13, borderRadius: 12, borderWidth: 1, borderColor: "rgba(62,207,178,0.3)" },
  primaryText: { color: theme.colors.accent, fontWeight: "700", fontSize: 14 },
  ...
  criticalGlow: {
    ...
    borderRadius: 16, borderWidth: 2, borderColor: "#f25c5c",
  },
  ...
  addBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginHorizontal: 16, marginBottom: 12, paddingVertical: 13, borderRadius: 12, backgroundColor: "#0f3a28", borderWidth: 1, borderColor: "rgba(62,207,178,0.3)" },
  addText: { color: theme.colors.accent, fontWeight: "700", fontSize: 14 },
  ...
  emptyText: { color: "#4a8a7a", fontSize: 15, fontWeight: "600" },
  emptySub: { color: "#2d5a52", fontSize: 12, textAlign: "center" },
  // Modals
  ...
  doneBtn: { marginTop: 20, paddingVertical: 14, borderRadius: 12, backgroundColor: "#0f3a28", borderWidth: 1, borderColor: "rgba(62,207,178,0.3)", alignItems: "center" },
  doneBtnText: { color: theme.colors.accent, fontWeight: "700", fontSize: 15 },
